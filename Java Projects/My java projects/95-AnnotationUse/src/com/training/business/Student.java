...
public class Student {
	...
	int rollNumber;
	@Column(columnName = "SNAME",columnType="STRING",CoumnWidth=10)
	String name;
	...
	char grade;
	@Column(columnName = "SDATEOFJOINING",columnType="DATE",CoumnWidth=10)
...
System.out.printf("%s%15d%15s%s%15.2f%10s%s%15s","\n",rollNumber,name,"\t",average,grade,"\t",dateOfJoining);
