...
public class ProductEditInputScreenServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher dispatcher=request.getRequestDispatcher("WEB-INF/Pages/JSP/ProductEditInput.jsp");
