...
public class ProductDeleteInputScreenServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher dispatcher=request.getRequestDispatcher("WEB-INF/Pages/JSP/ProductDeleteInput.jsp");
