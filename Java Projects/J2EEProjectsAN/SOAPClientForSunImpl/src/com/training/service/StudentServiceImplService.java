 ...
 * 
 */
@WebServiceClient(name = "StudentServiceImplService", targetNamespace = "http://service.training.com/", wsdlLocation = "http://localhost:8080/SOAPServiceSunImpl/sss?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICEIMPLSERVICE_QNAME = new QName("http://service.training.com/", "StudentServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SOAPServiceSunImpl/sss?wsdl");
    ...
    public StudentService getStudentServiceImplPort() {
        return super.getPort(new QName("http://service.training.com/", "StudentServiceImplPort"), StudentService.class);
    }
    ...
    public StudentService getStudentServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.training.com/", "StudentServiceImplPort"), StudentService.class, features);
    }
