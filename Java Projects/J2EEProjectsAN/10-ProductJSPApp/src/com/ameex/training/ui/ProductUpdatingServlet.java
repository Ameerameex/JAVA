...
public class ProductUpdatingServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			request.setAttribute("statusString", "There is a Problem in Updating");

		}
		if (status == true) {
			request.setAttribute("statusString", "Product Updated SuccessFully");

		} else {
			request.setAttribute("statusString", "Product Not Updated");
		}
